...
export default async function PrintEmployeeProfilePage(props: {
    ...
    return (
        <div className="max-w-[800px] mx-auto bg-white text-slate-900 font-sans text-xs print-container">
            {/* Print control banner */}
            <div className="p-10 pb-0 print:hidden">
                <PrintFichaClient />
            </div>

            {/* FOLHA 1 (A4) */}
            <div className="print-page p-10 space-y-6">
                {/* Title / Header */}
                ...
                <div className="pt-6 space-y-8">
                    ...
                    <div className="flex justify-between items-end pt-2">
                        <div className="w-1/2">
                            ...
                            <div className="border-b border-slate-400 w-3/4 pt-2 text-slate-400">Curitiba, ______ de ____________________ de 20____</div>
                        </div>
