...
export async function GET(request: Request) {
    try {
        ...
        const motivos: any = await prismaReembolso.$queryRawUnsafe(
            'SELECT id, descricao FROM "Motivo" WHERE ativo = true ORDER BY descricao ASC'
        );
        ...
        console.error("Erro ao buscar motivos do Reembolso Fácil:", error);
