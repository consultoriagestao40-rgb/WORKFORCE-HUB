...
import { 
    ...
    MessageCircle, Mail, Linkedin, Facebook, Instagram, Youtube, Award, Zap, CheckCircle, Flame, Filter, ChevronRight, Layers, UserCheck, Send, Globe
} from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] font-sans antialiased text-slate-900 selection:bg-teal-500 selection:text-white w-full">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 sm:-mt-7 relative z-20 pb-12 space-y-5">
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3 pt-3 border-t border-slate-100">
                                            {v.location && (
                                                <div className="flex items-start sm:items-center gap-2 text-xs font-semibold text-slate-700 bg-slate-50 px-3.5 py-2.5 rounded-2xl border border-slate-100/90">
                                                    <MapPin className="w-4 h-4 text-teal-600 shrink-0 mt-0.5 sm:mt-0" />
                                                    <span className="leading-snug break-words text-slate-800 font-bold">{v.location}</span>
                                                </div>
                                            )}
                ...
                {/* Footer Section */}
                <footer className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 text-center sm:text-left shadow-sm space-y-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-slate-100">
                        ...
                        {/* Official Domains & Contacts */}
                        <div className="flex flex-wrap items-center justify-center md:justify-end gap-2.5 text-xs text-slate-600 font-semibold">
                            <a 
                                href="https://www.grupojvsserv.com.br" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="flex items-center gap-1.5 bg-slate-50 hover:bg-teal-50 hover:text-teal-800 text-slate-700 px-3 py-1.5 rounded-xl border border-slate-200/80 transition-all shadow-2xs"
                                title="Acessar site oficial do Grupo JVS Serviços"
                            >
                            ...
                            <a 
                                href="https://www.jvsfacilities.com.br" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="flex items-center gap-1.5 bg-slate-50 hover:bg-teal-50 hover:text-teal-800 text-slate-700 px-3 py-1.5 rounded-xl border border-slate-200/80 transition-all shadow-2xs"
                                title="Acessar site oficial da JVS Facilities"
                            >
                                <Globe className="w-3.5 h-3.5 text-teal-600 shrink-0" />
                                <span>www.jvsfacilities.com.br</span>
                            </a>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 font-medium">
                        <p className="text-[11px]">© 2026 Grupo JVS Serviços. Todos os direitos reservados.</p>
                        <div className="flex items-center gap-3">
                            <span className="flex items-center gap-1.5 bg-slate-50 px-3 py-1 rounded-lg border border-slate-200/60 text-[11px] font-bold text-slate-600">
                                <ShieldCheck className="w-3.5 h-3.5 text-teal-600" /> LGPD Garantida
                            </span>
                            <span className="flex items-center gap-1.5 bg-slate-50 px-3 py-1 rounded-lg border border-slate-200/60 text-[11px] font-bold text-slate-600">
                                <Award className="w-3.5 h-3.5 text-amber-500" /> Empresa Certificada
                            </span>
                        </div>
                    </div>
                </footer>
